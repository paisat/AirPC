...
public class seekbarPreference extends Preference implements
	...
	private static final String SPAI = "spai";
	...
	private void setValuesFromXml(AttributeSet attrs) {
		...
		mMinValue = attrs.getAttributeIntValue(SPAI, "min", 0);

		
		mUnitsLeft = getAttributeStringValue(attrs, SPAI, "unitsLeft", "");
		String units = getAttributeStringValue(attrs, SPAI, "units", "");
		mUnitsRight = getAttributeStringValue(attrs, SPAI, "unitsRight", units);

		try {
			String newInterval = attrs.getAttributeValue(SPAI, "interval");
			if (newInterval != null)
